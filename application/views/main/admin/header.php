...
<head>
  ...
  <meta name="description" content="Sistem Informasi MBKM Fakultas Ekonomi dan Bisnis (FEB)">
  <meta name="keywords" content="Sistem Informasi MBKM Fakultas Ekonomi dan Bisnis (FEB)">
            ...
            <li class="profile-nav onhover-dropdown p-0 me-0">
              <div class="media profile-media"><img class="b-r-10" src="<?= base_url('assets/images/dashboard/profile.jpg'); ?>" alt="">
                <div class="media-body"><span><?= $this->session->fullname; ?></span>
                  <p class="mb-0 font-roboto"><?php echo $this->session->level == 3 ? $this->session->nama_mitra : $this->session->level_name; ?> <i class="middle fa fa-angle-down"></i></p>
                </div>
              </div>
              <ul class="profile-dropdown onhover-show-div">
                <li><a href="#"><i data-feather="user"></i><span>Account </span></a></li>
                <li><a href="<?= base_url('admin/auth/logout') ?>"><i data-feather="log-out"> </i><span>Log Out</span></a></li>
              </ul>
            </li>
          </ul>
        </div>
