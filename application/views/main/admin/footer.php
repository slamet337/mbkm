  ...
  <script>
    ...
    function jenis_print_lulus(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan').empty();
        $('#container_print_lulusan').append(`
        ...
        $('#container_print_lulusan').append(`
          <div class="row mt-4">
            <div class="col-md-6">
              <label class="col-sm-12 col-form-label">Dari</label>
              <div class="col-md-12">
                  <input class="form-control date_custom" type="date" name="date_from">
              </div>
            </div>
            <div class="col-md-6">
              <label class="col-sm-12 col-form-label">Sampai</label>
              <div class="col-md-12">
                  <input class="form-control date_custom" type="date" name="date_to">
              </div>
            </div>
          </div>
        `);
    ...
    function jenis_print_lulus_1(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_1').empty();
        $('#container_print_lulusan_1').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_2(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_2').empty();
        $('#container_print_lulusan_2').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_3(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_3').empty();
        $('#container_print_lulusan_3').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_4(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_4').empty();
        $('#container_print_lulusan_4').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_5(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_5').empty();
        $('#container_print_lulusan_5').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_6(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_6').empty();
        $('#container_print_lulusan_6').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_7(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_7').empty();
        $('#container_print_lulusan_7').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_8(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_8').empty();
        $('#container_print_lulusan_8').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
    ...
    function jenis_print_lulus_9(jenis) {
      if (jenis == '2') {
        $('#container_print_lulusan_9').empty();
        $('#container_print_lulusan_9').append(`
          <div class="col-md-12 mt-4">
            <select name="kd_prodi" class="form-select">
              <option value="">- Pilih Prodi - </option>
              <?php
        ...
        $('#container_print_lulusan_9').append(`
          <div class="row mt-4">
            <div class="col-md-12">
              <label class="col-sm-12 col-form-label">Tahun Penerbitan</label>
              <div class="col-md-12">
                <input type="number" class="form-control" min="1900" max="2099" value="2021" name="tahun" />
              </div>
            </div>
          </div>
        `);
    ...
    function showProdi(kd_jur) {
      var request = $.ajax({
        url: "<?= base_url('admin/prodi/show_prodi') ?>",
        method: "POST",
        data: { kd_jur },
        dataType: "json"
      });
    ...
    function convertNilai(nilai, id, angkatan) {
      if(angkatan <= '2014') {
        if(nilai <= 40) {
          $(`#grade_${id}`).val('E')
    ...
    function add_mk() {
      $("#container-kegiatan").append(`
        <div class="row" id="container-${count_container}">
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">Kode Matakuliah</label>
              <input class="form-control" type="text" name="kode_mk[]" placeholder="Kode Matakuliah">
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">Matakuliah</label>
              <input class="form-control" type="text" name="matakuliah[]" placeholder="Matakuliah">
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">SKS</label>
              <input class="form-control" type="number" name="sks[]" placeholder="SKS">
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              <label class="form-label">Mentor/Dosen</label>
              <select name="id_mentor[]" class="form-select js-example-basic-single">
                <option label="">- Pilih Mentor/Dosen -</option>
                <?php
                  if(isset($mentor)) {
                    foreach ($mentor as $show) {
                      echo "<option value='".$show->id."'>".$show->nama." (".$show->jabatan.")</option>";
                    }
                  }
                ?>
              </select>
          ...
          <div class="row">
            <div class="col-md-6">
              <a class="btn btn-primary" href="javascript:void(0)" onclick="add_mk()">Tambah</a>
              <a class="btn btn-danger" href="javascript:void(0)" onclick="hapus_mk('${count_container}')">Hapus</a>
            </div>
          </div>
          <br />
          <br />
    ...
    function check_program(id) {
      $("#container-kegiatan").empty();
      if (id == 1) {
        $("#container-kegiatan").append(`
          <div class="row">
            <div class="col-md-6">
                ...
                <input class="form-control" type="number" name="kuota" placeholder="Kuota">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<textarea name="job_desc" rows="3" class="form-control" placeholder="Keterangan"></textarea>
							</div>
						</div>
          </div>
        `);
    ...
    function datepicker_load() {
      ...
      ;(function ($) { $.fn.datepicker.language['id'] = {
          ...
          daysShort: ['M', 'SN', 'SL', 'R', 'K', 'J', 'SB'],
          daysMin: ['M', 'SN', 'SL', 'R', 'K', 'J', 'SB'],
