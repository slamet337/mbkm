    ...
    <div class="row">
      <div class="col">
        ...
        <section class="scroll-section" id="formRow">
          <h1 style="font-weight: bold; color: #166DB5">Register Mahasiswa Inbound</h1>
          <div class="card mb-5">
            <div class="card-body">
              <form class="row g-3" method="post" action="<?= base_url('auth/post_inbound') ?>" >
              <?php
              ...
              ?>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" require name="universitas_asal" />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Stambuk Asal</label>
                  <input type="text" class="form-control" require name="stambuk_asal" />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Fakultas Asal</label>
                  <input type="text" class="form-control" require name="fakultas_asal" />
                </div>
                <div class="col-md-6">
                  <label class="form-label">Prodi Asal</label>
                  <input type="text" class="form-control" require name="prodi_asal" />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control" require name="angkatan" id="angkatan" />
                </div>
                <div class="col-12">
