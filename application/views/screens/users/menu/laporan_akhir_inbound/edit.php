    ...
    <div class="row">
      ...
      <div class="col-6">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('laporan_akhir_inbound'); ?>"><i data-feather="clipboard"></i></a></li>
...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('laporan_akhir_inbound/update/'.$laporan_akhir_inbound->id) ?>" enctype="multipart/form-data">
          <?php
              if (isset($error)) {
            ?>
        ...
        <div class="card-footer">
          ...
          <a href="<?= base_url('laporan_akhir_inbound') ?>" class="btn btn-light" >Cancel</a>
        </div>
      </form>
    </div>
  </div>
