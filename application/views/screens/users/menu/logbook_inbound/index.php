...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        <div class="mb-4 ">
          <a class="btn btn-outline-primary" href="<?= base_url('logbook_inbound/add'); ?>">Tambah Logbook</a>
        </div>
        <div class="table-responsive">
          <table class="display" id="basic-1">
            ...
            <tbody>
              <?php
                $CI =& get_instance();
                foreach ($logbook_inbound as $show) {
                  echo "
                    <tr>
                      ...
                      <td>
                        <a class='btn btn-outline-warning' href='".base_url('logbook_inbound/edit/').$show->id."'>Edit</a>
                        <a href='javascript:deleteData(\"".$show->id."\", \"logbook_inbound\");' class='btn btn-outline-danger'>Hapus</a>
                      </td>
                    </tr>
                  ";
                }
