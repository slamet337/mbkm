...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('logbook_inbound/post') ?>" enctype="multipart/form-data">
          <?php
            ...
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input class="datepicker-here form-control digits" name="tanggal" type="text" data-language="id">
                </div>
              </div>
            </div>
            <div class="col-md-9">
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="kegiatan_dilakukan" placeholder="Kegiatan yang dilakukan">
              </div>
            </div>
          </div>
          <div class="row">
