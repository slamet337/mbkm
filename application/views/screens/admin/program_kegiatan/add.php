  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h5>Add Program Kegiatan MBKM</h5>
      </div>
      <form class="form theme-form" method="post" action="<?= base_url('admin/program_kegiatan/post') ?>">
          <?php
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select name="id_program" onchange="check_program(this.value)" class="form-select js-example-basic-single">
                  <option label="" value="">- Pilih Program -</option>
                  <?php
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="nama_kegiatan" placeholder="Nama Kegiatan / Jenis Pekerjaan">
              </div>
            </div>
          </div>
