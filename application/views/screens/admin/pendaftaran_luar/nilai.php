...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('admin/pendaftaran_luar/update_nilai/'.$mahasiswa->id) ?>">
          <?php
        ...
        <div class="card-body">
          ...
          ?>
            <div class="mb-3 row">
              ...
              <div class="col-md-3">
                  <input class="form-control" type="hidden" name="id[]" value="<?= $show->id; ?>">
                  <input class="form-control" type="number" name="nilai[]" placeholder="Nilai" onkeyup="convertNilai(this.value, '<?= $show->id ?>', '<?= $mahasiswa->angkatan ?>')">
              </div>
              <div class="col-md-3">
        ...
        <div class="card-footer">
          ...
          <a href="<?= base_url('admin/pendaftaran_luar') ?>" class="btn btn-light" >Cancel</a>
        </div>
      </form>
    </div>
  </div>
