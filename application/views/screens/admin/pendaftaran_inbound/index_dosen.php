  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h5>List Pendaftaran (List Data Mahasiswa akan Kosong jika sudah diberi nilai)</h5>
      </div>
      <div class="card-body">
                ...
                foreach ($pendaftaran as $show) {
                  ...
                  echo "
                    <tr>
                      ...
                      <td>".$show->semester."</td>
                      <td>
                        <a class='btn btn-primary' href='".base_url('admin/pendaftaran_inbound_dosen/logbook/'.$show->id_mhsw.'/'.$show->semester)."'>Logbook</a>
                        <a class='btn btn-success' href='".base_url($show->file_laporan_akhir)."'>Laporan Akhir</a>
                        <a class='btn btn-info' href='".base_url('admin/pendaftaran_inbound_dosen/nilai/'.$show->id)."'>Penilaian</a>
                      </td>
                    </tr>
                  ";
                }
