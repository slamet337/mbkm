    ...
    <div class="row">
      ...
      <div class="col-6">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('admin/pendaftaran_inbound_dosen'); ?>"><i data-feather="users"></i></a></li>
...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('admin/pendaftaran_inbound_dosen/update/'.$pendaftaran->id) ?>">
          <?php
        ...
        <div class="card-footer">
          ...
          <a href="<?= base_url('admin/pendaftaran_inbound_dosen') ?>" class="btn btn-light" >Cancel</a>
        </div>
      </form>
    </div>
  </div>
