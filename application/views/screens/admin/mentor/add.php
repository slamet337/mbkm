...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('admin/mentor/post') ?>">
          <?php
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input class="form-control" type="number" name="phone_number" placeholder="Nomor HP">
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="pendidikan_terakhir" placeholder="Pendidikan Terakhir">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Sertifikasi/Keahlian</label>
                <input class="form-control" type="text" name="sertifikasi_keahlian" placeholder="Sertifikasi/Keahlian">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select name="jenis_personil" class="form-select">
                  ...
                  <option value="Dosen Penanggung Jawab">Dosen Penanggung Jawab</option>
