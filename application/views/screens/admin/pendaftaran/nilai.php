...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('admin/pendaftaran_dosen/update/'.$pendaftaran->id) ?>">
          <?php
        ...
        <div class="card-footer">
          ...
          <a href="<?= base_url('admin/pendaftaran_dosen') ?>" class="btn btn-light" >Cancel</a>
        </div>
      </form>
    </div>
  </div>
