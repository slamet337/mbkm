...
<div class="container-fluid">
  <div class="col-sm-12">
    <div class="card">
      ...
      <form class="form theme-form" method="post" action="<?= base_url('admin/pendaftaran_mitra/update_nilai/'.$pendaftaran->id) ?>">
          <?php
        ...
        <div class="card-body">
          ...
          ?>
            <div class="mb-3 row">
              <label class="col-md-3 form-label"><?= $show->matakuliah_pertukaran; ?></label>
              <div class="col-md-3">
                  <input class="form-control" type="hidden" name="id_mk[]" value="<?= $show->id; ?>">
                  <input class="form-control" type="number" name="nilai[]" placeholder="Nilai" onkeyup="convertNilai(this.value, '<?= $show->id ?>', '<?= $pendaftaran->angkatan ?>')">
              </div>
              <div class="col-md-3">
