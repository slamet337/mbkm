                ...
                foreach ($pendaftaran as $show) {
                  ...
                  echo "
                    <tr>
                      ...
                      <td>".$show->semester."</td>
                      <td>
                        <a class='btn btn-primary' href='".base_url('admin/pendaftaran_dosen/logbook/'.$show->id)."'>Logbook</a>
                  ...
                  if($show->id_program == 1) {
                    ...
                    echo "
                          <a class='btn btn-info' href='".base_url('admin/pendaftaran_dosen/nilai/'.$show->id.'/'.$show->id_kegiatan)."'>Penilaian</a>
                        </td>
                      </tr>
                    ";
                  }
