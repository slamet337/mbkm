<?php
  ...
  class Profil extends CI_Controller {
    ...
    {
      $profil = $this->profil_model->get_profil_dosen_one($this->session->id)->row();
      $data['profil'] = $profil;
      $id_dosen = $profil->id;
      $data['prodi'] = $this->profil_model->get_prodi_all()->result();
      $data['content'] = 'profil/index';
      $data['tab'] = 'biodata';
      $data['pendidikan'] = $this->profil_model->get_pendidikan_dosen($id_dosen)->result();
      $data['pekerjaan'] = $this->profil_model->get_pekerjaan_dosen($id_dosen)->result();
      $data['jabatan'] = $this->profil_model->get_jabatan_dosen($id_dosen)->result();
      $data['wirausaha'] = $this->profil_model->get_wirausaha_dosen($id_dosen)->result();
      $data['seminar'] = $this->profil_model->get_seminar_dosen($id_dosen)->result();
      $data['prestasi'] = $this->profil_model->get_prestasi_dosen($id_dosen)->result();
      $data['karya_ilmiah'] = $this->profil_model->get_karya_ilmiah_dosen($id_dosen)->result();
      $data['organisasi'] = $this->profil_model->get_organisasi_dosen($id_dosen)->result();
      $data['mbkm'] = $this->profil_model->get_mbkm_dosen($id_dosen)->result();
      $data['mbkm_luar'] = $this->profil_model->get_mbkm_luar_dosen($id_dosen)->result();
    ...
    public function update($id)
    {
      ...
      $this->form_validation->set_rules('nip', 'NIK / NIP / NIDN', 'required');
      ...
      $this->form_validation->set_rules('pangkat_gol', 'Pangkat/Golongan', 'required');
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_dosen($data, $id)) {
    ...
    public function post_pendidikan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_pendidikan_dosen($data_pendidikan)) {
    ...
    public function put_pendidikan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_pendidikan_dosen($data_pendidikan, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_pendidikan_dosen($this->input->post('id'))) {
        $data->status = "success";	
    ...
    public function post_pekerjaan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_pekerjaan_dosen($data_pekerjaan)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_pekerjaan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_pekerjaan_dosen($data_pekerjaan, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_pekerjaan_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_jabatan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_jabatan_dosen($data_jabatan)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_jabatan($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_jabatan_dosen($data_jabatan, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_jabatan_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_wirausaha($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_wirausaha_dosen($data_wirausaha)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_wirausaha($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_wirausaha_dosen($data_wirausaha, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_wirausaha_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_seminar($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_seminar_dosen($data_seminar)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_seminar($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_seminar_dosen($data_seminar, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_seminar_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_prestasi($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_prestasi_dosen($data_prestasi)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_prestasi($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_prestasi_dosen($data_prestasi, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_prestasi_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_karya_ilmiah($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_karya_ilmiah_dosen($data_karya_ilmiah)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_karya_ilmiah($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_karya_ilmiah_dosen($data_karya_ilmiah, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_karya_ilmiah_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function post_organisasi($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->post_organisasi_dosen($data_organisasi)) {
          $this->session->set_flashdata('success_save', TRUE);
        } else {
          $this->session->set_flashdata('error_save', TRUE);
        }
    ...
    public function put_organisasi($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if ($this->profil_model->put_organisasi_dosen($data_organisasi, $id)) {
          $this->session->set_flashdata('success_update', TRUE);
        } else {
          $this->session->set_flashdata('error_update', TRUE);
        }
    ...
    {
      $data = new stdClass();
      if ($this->profil_model->delete_organisasi_dosen($this->input->post('id'))) {
        $data->status = "success";	
        $data->id = $this->input->post('id');
      } else {
        $data->status = "failed";	
    ...
    public function setting($id)
    {
      ...
      if ($this->form_validation->run() === FALSE) {
        ...
        if (password_verify($this->input->post('old_password'), $cek_login->password)) {
          ...
          if ($this->profil_model->put_setting_dosen($data_setting, $this->session->id)) {
            $this->session->set_flashdata('success_save', TRUE);
          } else {
            $this->session->set_flashdata('error_save', TRUE);
          }
    ...
    {
      $biodata = $this->profil_model->get_profil_dosen_one($this->session->id)->row();
      $id_dosen = $biodata->id;
        ...
        $pendidikan = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_pendidikan = $this->profil_model->get_pendidikan_dosen($id_dosen)->result();
              $i = 1;
        ...
        $pekerjaan = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_pekerjaan = $this->profil_model->get_pekerjaan_dosen($id_dosen)->result();
              $i = 1;
        ...
        $jabatan = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_jabatan = $this->profil_model->get_jabatan_dosen($id_dosen)->result();
              $i = 1;
        ...
        $wirausaha = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_wirausaha = $this->profil_model->get_wirausaha_dosen($id_dosen)->result();
              $i = 1;
        ...
        $seminar = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_seminar = $this->profil_model->get_seminar_dosen($id_dosen)->result();
              $i = 1;
        ...
        $prestasi = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_prestasi = $this->profil_model->get_prestasi_dosen($id_dosen)->result();
              $i = 1;
        ...
        $karya_ilmiah = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_karya_ilmiah = $this->profil_model->get_karya_ilmiah_dosen($id_dosen)->result();
              $i = 1;
        ...
        $organisasi = '
          ...
          <div style="margin-top: 20px; margin-bottom: 40px">
            <table id="mbkm">
              ...
              $data_organisasi = $this->profil_model->get_organisasi_dosen($id_dosen)->result();
              $i = 1;
              ...
              <div style="margin-top: 20px; margin-bottom: 40px">
                <table id="mbkm">
                  ...
                  <tr>
                    ...
                    <td>'.$biodata->tempat_lahir.', '.$this->tgl_indo($biodata->tanggal_lahir).'</td>
                  </tr>
                  <tr>
                    <td>Agama</td>
                    <td>'.$biodata->agama.'</td>
                  ...
                  <tr>
                    ...
                    <td>'.$biodata->jabatan_fungsional.'</td>
                  </tr>
                  <tr>
                    <td>Nomor HP</td>
